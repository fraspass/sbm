...
The model and datasets are described in *Sanna Passino, F. and Heard, N. A., "Bayesian estimation of the latent dimension and communities in stochastic blockmodels", Statistics and Computing, to appear* ([link to the paper](https://link.springer.com/article/10.1007/s11222-020-09946-6)). 
